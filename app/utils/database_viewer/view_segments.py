#!/usr/bin/env python3
"""
Segment Viewer - Utility to view all segments of a function
...
def display_segments(session, function, segments, show_target=False, colorize=False):
    ...
    for i, segment in enumerate(segments):
        ...
        seg_id, seg_type, content, lineno, end_lineno, index, target_id, segment_data = segment
        
        # Print segment header
        print(f"\nSEGMENT {i+1}: [{seg_type.upper()}]")
...
def main():
    ...
    if function_result:
        ...
        # Display segments
        display_segments(session, function, segments, args.show_target, args.colorize)
